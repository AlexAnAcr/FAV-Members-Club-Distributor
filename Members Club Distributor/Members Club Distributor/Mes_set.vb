Public Class Mes_set
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If exist_reg = True Then
            ...
            Dim names() As String = {"StartMessange", "InactiveMessangeTime", "MessangeSound", "DistributingStartMessange", "DistributingEndMessange", "SaveMessange", "DBLoad", "DBLoaded"}, reg_values() As String = reg.GetValueNames
            ...
            reg.SetValue("DBLoad", Main.settings(7), Microsoft.Win32.RegistryValueKind.DWord)
            reg.SetValue("DBLoaded", Main.settings(8), Microsoft.Win32.RegistryValueKind.DWord)
            reg.Close()
            Me.Close()
        Else
            reg.Close()
