...
> Вашему вниманию предлагается один из наиболее интересных репозиториев AlexAnAcr.
...
> P.S.
> Как вы, наверное, заметили, это реальный проект (а не шутка или развлечение), который был разработан как внутренняя утилита для организаторов. Когда-то я хотел опубликовать этот проект в своем основном профиле, но не хотел размещать там проекты на языке Visual Basic, поэтому мне пришлось поместить его в профиль-архив на BitBucket (который не индексируется, и найти его там практически невозможно). Если бы этот проект был написан хотя бы на C#... По всем остальным параметрам он вполне дотягивает до проекта основного профиля.
